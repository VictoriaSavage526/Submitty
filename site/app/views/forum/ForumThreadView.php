...
HTML;
					...
					if($display_option == "tree"){
						...
						foreach($order_array as $ordered_post){
							foreach($posts as $post){
								if($post["id"] == $ordered_post){
									...
									$return .= $this->createPost($thread_id, $post, $unviewed_posts, $function_date, $title_html, $first, $reply_level, $display_option, $includeReply, $attachmentButton);
						...
						foreach($posts as $post){
							...
							$return .= $this->createPost($thread_id, $post, $unviewed_posts, $function_date, $title_html, $first, 1, $display_option, $includeReply, $attachmentButton);		
...
HTML;
	...
	public function createPost($thread_id, $post, $unviewed_posts, $function_date, $title_html, $first, $reply_level, $display_option, $includeReply, &$globalAttachments = array()){
