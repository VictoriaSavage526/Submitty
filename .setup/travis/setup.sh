...
bash -c "echo 'export PATH=${PATH}' >> /home/${CGI_USER}/.profile"
bash -c "echo 'export PATH=${PATH}' >> /home/${CGI_USER}/.bashrc"
bash -c "echo 'export PATH=${PATH}' >> /home/${DAEMON_USER}/.profile"
